...
# Geografické informační systémy {: .page_title}
...
GIS má široké uplatnění, od __městského plánování__, přes __správu přírodních zdrojů__ až po __krizový management__. Je nepostradatelným nástrojem pro efektivní rozhodování a řízení v různých odvětvích a pomáhá lépe pochopit složité geografické souvislosti. Předmět je do tohoho tématu opravdu jen úvodem. Provede vás základní teorií a budeme se věnovat praktickému ovládání GIS software – zejména porozumění práce s daty a provádění jednodušších analýz. Během výuky je používán software __:simple-arcgis: Esri ArcGIS Pro__{: style="white-space: nowrap;"}, pokud zbude čas, ke konci věnujeme prostor i možným alternativám (program __:simple-qgis: QGIS__).
